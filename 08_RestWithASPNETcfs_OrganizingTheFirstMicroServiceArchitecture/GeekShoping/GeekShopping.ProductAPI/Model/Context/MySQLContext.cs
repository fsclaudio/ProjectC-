    ...
    public class MySQLContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Product>().HasData(new Product {
                Id = 4,
                Name="Work day",
                Price= new decimal(60.66),
                Description = "It is my life",
                ImageUrl= "https://www.incimages.com/uploaded_files/image/1920x1080/getty_516722612_200013342000928081_128034.jpg",
                CategoryName="Life"
            });
            modelBuilder.Entity<Product>().HasData(new Product
            {
