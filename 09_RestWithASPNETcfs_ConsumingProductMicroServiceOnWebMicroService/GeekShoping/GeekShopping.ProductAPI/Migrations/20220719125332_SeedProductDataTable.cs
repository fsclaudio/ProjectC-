    ...
    public partial class SeedProductDataTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                table: "product",
                columns: new[] { "id", "catego_name", "description", "image_url", "name", "price" },
                values: new object[,]
                {
                    { 4L, "Life", "It is my life", "https://www.incimages.com/uploaded_files/image/1920x1080/getty_516722612_200013342000928081_128034.jpg", "Work day", 60.66m },
